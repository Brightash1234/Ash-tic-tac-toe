...
void
intializeBoard (char board[][SIDE])
{
...
declareWinner (int whoseTurn)
{
  if (whoseTurn == COMPUTER)
    cout << "COMPUTER has won the match\n";
  else
    cout << "HUMAN has won the match \n";
}
...
//Function to return the best moveIndex
...
playTicTacToe (int whoseTurn)
{
  ...
  while (gameOver (board) == false && moveIndex != SIDE * SIDE)
	...
	{
	  cout << "You can insert the following positions : ";
	  for (int i = 0; i < SIDE; i++)
	    {
	      for (int j = 0; j < SIDE; j++)
		{
